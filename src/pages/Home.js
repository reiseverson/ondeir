...
class Home extends Component {
  state = {
    ...
    fm: this.props.match.params.fm,
    sentence: 'Fique em casa!',
    snackActive: false,
    url: 'https://ondeirnofimdesemana.com'
  }
  ...
  handleFm = e => {
    this.setState({fm: !this.state.fm})
  ...
  render(){
    return (
      ...
      <div className="container">
        <div className = {this.state.snackActive ? 'snackbar show' : 'snackbar'}>
          Link copiado!
        </div>
        <div className="topBar">
          <form id="city" onSubmit={this.handleSubmit}>
            <input 
              placeholder="Cidade"
              className="city"
          ...
          <div className="content">
            {
              ...
              <Typewriter
                onInit={(typewriter) => {
                  typewriter.typeString(this.state.sentence)
                    .callFunction(() => {
                      this.setState({ showResults: true })
                    })
                    .start();
